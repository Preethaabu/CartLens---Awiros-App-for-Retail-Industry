...
model= YOLO('E:\\Projects\\object_detection\\data\\first_yolo\\best (1).pt')
...
message = """
explain this yolo object detection output that i provided in all coords variable to alert the blind person
